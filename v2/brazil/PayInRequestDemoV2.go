...
func PayInRequestDemoV2(env string, merchantId string, merchantSecret string, privateKey string, paymentMethod string, amount int, pixAccount string) {
	...
	payer := bean.Payer{PixAccount: pixAccount}
