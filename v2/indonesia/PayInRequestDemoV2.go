...
func PayInRequestDemoV2(env string, merchantId string, merchantSecret string, privateKey string, paymentMethod string, amount int, ovoAccount string) {
	...
	payer := bean.Payer{Phone: ovoAccount}
